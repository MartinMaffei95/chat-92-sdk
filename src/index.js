...
(function (window) {
  ...
  SDKlm.prototype.builderBubble = function () {
    ...
    if (!checkExisteBubble) {
      const htmlRaw = [
        ...
        ' <div class="lm-hi" id="hi-bubble"><span>Hola! aqui estoy</span></div>',
        '</div>',
      ].join('');
  ...
  SDKlm.prototype.loadListeners = function () {
    ...
    mlBubbleHiMsg = document.querySelector('#hi-bubble');
  ...
  function checkIframeStatus() {
    ...
    if (!iframeState) {
      ...
      mlBubbleHiMsg.classList.add('display-none');
    ...
    if (iframeState) {
      ...
      mlBubbleHiMsg.classList.remove('display-none');
